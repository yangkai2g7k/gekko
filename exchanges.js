...
var exchanges = [
    ...
    },
    {
        ...
        slug: 'yunbi',
        currencies: ['CNY'],
        assets: ['BTC', 'ETH', 'DGD','BTS','SC','ETC','1SŦ','REP','ANS','ZEC','ZMC','GNT','QTUM','GXS','EOS'],
        markets: [
            {pair: ['CNY', 'BTC'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'ETH'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'DGD'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'BTS'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'SC'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'ETC'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', '1SŦ'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'REP'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'ANS'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'ZEC'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'ZMC'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'GNT'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'QTUM'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'GXS'], minimalOrder: {amount: 0.01, unit: 'asset'}},
            {pair: ['CNY', 'EOS'], minimalOrder: {amount: 0.01, unit: 'asset'}}
        ],
        requires: ['key', 'secret'],
        providesHistory: 'tid',
        providesFullHistory: true,
